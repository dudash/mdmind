...
`mdmind` ships base skills in [../../plugins/mdmind/skills](../../plugins/mdmind/skills). Use those first:
...
| The base mdmind behavior should change for everyone | update the shipped skills in [../../plugins/mdmind/skills](../../plugins/mdmind/skills) |
...
- [Plugin and skills README](../../plugins/mdmind/README.md)
