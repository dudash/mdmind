...
Ideas worth preserving after the CLI MVP:
...
- Export targets beyond JSON, especially Mermaid and OPML.
- Saved filters such as `#todo` or `@status:blocked` for recurring workflows.
- Optional relation edges for non-tree references between nodes.
